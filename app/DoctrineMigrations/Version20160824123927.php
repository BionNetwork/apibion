 ...
 */
class Version20160824123927 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE activation (id SERIAL NOT NULL, card_id INT NOT NULL, user_id INT NOT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE card (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, price NUMERIC(10, 0) NOT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE card_representation (id SERIAL NOT NULL, activation_id INT DEFAULT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, card_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE dashboard_card (id SERIAL NOT NULL, dashboard_id INT NOT NULL, activation_id INT NOT NULL, user_id INT NOT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_164F7D1B9D04D2B ON dashboard_card (dashboard_id)');
        $this->addSql('CREATE INDEX IDX_164F7D1116B3934 ON dashboard_card (activation_id)');
        $this->addSql('CREATE INDEX IDX_164F7D1A76ED395 ON dashboard_card (user_id)');
        $this->addSql('CREATE INDEX dashboard_card_create_on_idx ON dashboard_card (created_on)');
        ...
        $this->addSql('CREATE TABLE resource (id SERIAL NOT NULL, activation_id INT NOT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, path VARCHAR(1024) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE dashboard_card ADD CONSTRAINT FK_164F7D1B9D04D2B FOREIGN KEY (dashboard_id) REFERENCES dashboard (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE dashboard_card ADD CONSTRAINT FK_164F7D1116B3934 FOREIGN KEY (activation_id) REFERENCES activation (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE dashboard_card ADD CONSTRAINT FK_164F7D1A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dashboard_card DROP CONSTRAINT FK_164F7D1116B3934');
        ...
        $this->addSql('ALTER TABLE dashboard_card DROP CONSTRAINT FK_164F7D1B9D04D2B');
        ...
        $this->addSql('ALTER TABLE dashboard_card DROP CONSTRAINT FK_164F7D1A76ED395');
